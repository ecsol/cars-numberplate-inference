...
ORIENTATION_OPERATIONS = {
    ...
    5: lambda img: cv2.flip(cv2.rotate(img, cv2.ROTATE_90_COUNTERCLOCKWISE), 1),  # 90度反時計回り+水平反転
    6: lambda img: cv2.rotate(img, cv2.ROTATE_90_CLOCKWISE),  # 90度時計回り
    7: lambda img: cv2.flip(cv2.rotate(img, cv2.ROTATE_90_CLOCKWISE), 1),  # 90度時計回り+水平反転
